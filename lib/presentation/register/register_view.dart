...
class _RegisterNamePageState extends State<RegisterView> {
  ...
  Widget currentImage() {
    if (registerationProviderWatch!.index == 0) {
      return  imageLottieWidget(ImageAssets.nameLottie, context);/*imageWidget(ImageAssets.welcomePic, context)*/;
    } else if (registerationProviderWatch!.index == 1) {
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        smileWidget(
                            registerationProviderWatch!.index >= 1 ? true : false,
                            context),
                        Container(
                            decoration: BoxDecoration(
                              color:registerationProviderWatch!.index >= 1 ? ColorManager.green: ColorManager.lightGrey,
                              border:
                                  Border.all(color: ColorManager.lightPrimary),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        smileWidget(
                            registerationProviderWatch!.index >= 2 ? true : false,
                            context),
                        Container(
                            decoration: BoxDecoration(
                              color:registerationProviderWatch!.index >= 2 ? ColorManager.green: ColorManager.lightGrey,
                              border:
                                  Border.all(color: ColorManager.lightPrimary),
                              shape: BoxShape.circle,
                            ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        smileWidget(
                            registerationProviderWatch!.index >= 3 ? true : false,
                            context),
                         Container(
                            decoration: BoxDecoration(
                              color:registerationProviderWatch!.index >= 3 ? ColorManager.green: ColorManager.lightGrey,
                              border:
                                  Border.all(color: ColorManager.lightPrimary),
                              shape: BoxShape.circle,
                            ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        smileWidget(
                            registerationProviderWatch!.index >= 4 ? true : false,
                            context),
                         Container(
                            decoration: BoxDecoration(
                              color:registerationProviderWatch!.index >= 4 ? ColorManager.green: ColorManager.lightGrey,
                              border:
                                  Border.all(color: ColorManager.lightPrimary),
                              shape: BoxShape.circle,
                            ),
